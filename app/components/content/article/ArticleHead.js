    ...
    render() {
        ...
        return (
            <header className="article-header">
                <h1 className="article-title"><a href="http://cuiqingcai.com/4833.html">{title}</a></h1>
                <div className="meta">
                    ...
                    <span className="muted"><i className="fa fa-eye"></i> {visit}</span>
                    <span className="muted"><i className="fa fa-comments-o"></i> <a href="http://cuiqingcai.com/4833.html#comments">{comment}</a></span>							</div>
            </header>
        );
    }
}