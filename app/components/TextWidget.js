                        ...
                        <a className="weixin">
                            ...
                            <div className="weixin-popover">
                                <div className="popover bottom in">
                                    ...
                                    <div className="popover-content"><img src="http://cuiqingcai.com/wp-content/themes/Yusi/img/weixin.gif"/></div>
                                </div>
                            </div>
                        </a>
                        <a href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=cqc@cuiqingcai.com" rel="external nofollow" title="Email" target="_blank"><i className="email fa fa-envelope-o"></i></a>
                        <a href="?feed=rss2" rel="external nofollow" target="_blank" title="订阅本站"><i className="rss fa fa-rss"></i></a>
                        <a></a>
                    </div>
                </div>
            </div>
